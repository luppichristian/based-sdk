...
func process_pipe process_get_stdin(process prc) {
  ...
  return (process_pipe)SDL_GetProcessInput((SDL_Process*)prc);
}
...
func process_pipe process_get_stdout(process prc) {
  ...
  return (process_pipe)SDL_GetProcessOutput((SDL_Process*)prc);
}
...
func process_pipe process_get_stderr(process prc) {
  ...
  return (process_pipe)SDL_GetPointerProperty(props, SDL_PROP_PROCESS_STDERR_POINTER, NULL);
}
